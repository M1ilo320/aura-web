    ...
    <div className="app-wrapper">
      ...
      <style>{`
        ...
        * { box-sizing: border-box; font-family: 'Montserrat', sans-serif; }
        ...
        .hero-dots .dot.active { background: var(--primary); width: 60px; box-shadow: 0 0 15px var(--primary); }
        ...
        .item-card { background: #1a1a1c; border: 1px solid rgba(201, 206, 214, 0.3); border-radius: 35px; padding: 35px; transition: 0.4s; position: relative; overflow: hidden; }
        .item-card:hover { border-color: var(--primary); transform: translateY(-12px); background: #1e1e21; box-shadow: 0 40px 80px rgba(0,0,0,0.6); }
