      ...
      <nav className="home-nav">
        <div className="home-nav-container">
          ...
          <div className="home-socials">
            <a href="#" className="s-icon trophy" title="Rankings">
              <svg width="22" height="22" viewBox="0 0 512 512" fill="currentColor"><path d="M464 64h-48V48c0-26.51-21.49-48-48-48H144c-26.51 0-48 21.49-48 48v16H48C21.49 64 0 85.49 0 112v96c0 68.39 49.38 125.26 114.91 136.21 21.03 40.5 59.86 71.9 107.09 82.47V448h-64c-17.67 0-32 14.33-32 32v16c0 8.84 7.16 16 16 16h176c8.84 0 16-7.16 16-16v-16c0-17.67-14.33-32-32-32h-64v-21.31c47.23-10.57 86.06-41.97 107.09-82.47C462.62 333.26 512 276.39 512 208v-96c0-26.51-21.49-48-48-48zM64 208v-80h32v108.51c-19.14-12.75-32-34.14-32-28.51zm384 0c0 5.63-12.86 15.76-32 28.51V128h32v80z" /></svg>
            </a>
            ...
            <a href="https://instagram.com/TWOJ-LINK" target="_blank" rel="noreferrer" className="s-icon instagram" title="Instagram">
