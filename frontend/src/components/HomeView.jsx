      ...
      <nav className="home-nav">
        <div className="home-nav-container">
          ...
          <div className="home-socials">
            <a href="https://discord.gg/PMr6rJWsjx" target="_blank" rel="noreferrer" className="s-icon" title="Discord">
            ...
            <a href="https://tiktok.com/@TWOJ-LINK" target="_blank" rel="noreferrer" className="s-icon" title="TikTok">
          ...
          <div className="server-grid">
            {shops.map(shop => (
              <Link key={shop.id} to={`/s/${shop.slug}`} className="server-card">
                ...
                <div className="server-status">SKLEP INTERNETOWY</div>
                <div className="join-btn">WEJDŹ</div>
              </Link>
            ))}
          </div>
        </div>
